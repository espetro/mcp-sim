...
func New(cfg config.IOSConfig) (*Platform, error) {
...
func (p *Platform) xcrun(args ...string) *exec.Cmd {
...
func (p *Platform) simctlJSON() ([]byte, error) {
	cmd := p.xcrun("simctl", "list", "devices", "--json")
	return cmd.Output()
}
...
func (p *Platform) Start(ctx context.Context, target string, opts contract.StartOpts) (contract.Device, error) {
	cmd := p.xcrun("simctl", "boot", target)
...
func (p *Platform) Stop(ctx context.Context, target string) error {
	cmd := p.xcrun("simctl", "shutdown", target)
...
func (p *Platform) State(ctx context.Context, target string) (contract.DeviceState, error) {
	out, err := p.xcrun("simctl", "list", "devices", "booted", "--json").Output()
	if err != nil {
...
func (p *Platform) Wipe(ctx context.Context, target string) error {
	...
	cmd := p.xcrun("simctl", "erase", target)
	if err := cmd.Run(); err != nil {
...
func (p *Platform) OpenURL(ctx context.Context, target, url string) error {
	cmd := p.xcrun("simctl", "openurl", target, url)
	if err := cmd.Run(); err != nil {
